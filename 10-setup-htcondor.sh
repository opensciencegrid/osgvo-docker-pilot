...
if [[ -z $OSG_DEFAULT_CONTAINER_DISTRIBUTION_GPU ]]; then
    OSG_DEFAULT_CONTAINER_DISTRIBUTION_GPU="100%__htc/rocky:9-cuda-12.6.0"
fi
...
OSG_DEFAULT_CONTAINER_DISTRIBUTION_GPU $OSG_DEFAULT_CONTAINER_DISTRIBUTION_GPU
